...
parser.add_argument("-oforcefig", type= str, default="force_homo.pdf", \
    help = "Output to a force displacement PDF file")
parser.add_argument("-omfig", type= str, default="menisci_homo.pdf", \
...
fig = plt.figure(figsize=(8, 6))
ax2 = fig.add_subplot(111, ylim = (-0.5, 1.25), xlim = (-1.0, 3.0))
